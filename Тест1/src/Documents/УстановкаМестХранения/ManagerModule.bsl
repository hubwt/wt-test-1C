...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.Текст =
		ТекстЗапросаМестаХраненияНоменклатуры(НомераТаблиц);
...
Функция ТекстЗапросаРеквизитыДокумента(НомераТаблиц)
	...
	|ПОМЕСТИТЬ Реквизиты
	|ИЗ
	|	Документ.УстановкаМестХранения КАК Реквизиты
	|ГДЕ
...
Функция ТекстЗапросаМестаХраненияНоменклатуры(НомераТаблиц)

	НомераТаблиц.Вставить("ТаблицаМестаХраненияНоменклатуры", НомераТаблиц.Количество());
	...
	|	Товары.МестоХраненияПолучатель КАК МестоХранения
	|ИЗ
	|	Документ.УстановкаМестХранения.Товары КАК Товары,
	|	Реквизиты КАК Реквизиты
	|ГДЕ
