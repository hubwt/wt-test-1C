...
Процедура НачатьПоиск()
	...
	ТекстЗапроса = "ВЫБРАТЬ
	                      ...
	                      |ИЗ
	                      |	Документ.ПредварительныйСчет КАК ПродажаЗапчастей";
	ном = 1;
	Для Каждого элем из Пск Цикл
		Если ном = 1 Тогда
			ТекстЗапроса = ТекстЗапроса + " ГДЕ ПродажаЗапчастей.Номер ПОДОБНО ""%"+элем+""" ИЛИ ПродажаЗапчастей.Клиент.Наименование ПОДОБНО ""%"+элем+"%"""+ " ИЛИ ПродажаЗапчастей.Клиент.ФИО ПОДОБНО ""%"+элем+"%""" + " ИЛИ ПродажаЗапчастей.Клиент.Телефон ПОДОБНО ""%"+элем+"%""";
		Иначе
