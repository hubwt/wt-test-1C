...
Функция ПечатьАктСписанияНаСервере()
	...
	Макет = Документы.ПеремещениеТМЦ.ПолучитьМакет("АктПеремещения");
	
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ПеремещениеТМЦСписокТМЦ.НомерСтроки КАК НомерСтроки,
	|	ПеремещениеТМЦСписокТМЦ.ТМЦ КАК ТМЦ,
	|	ПеремещениеТМЦСписокТМЦ.Количество КАК Количество,
	|	ПеремещениеТМЦСписокТМЦ.Цена КАК Цена,
	|	ПеремещениеТМЦСписокТМЦ.Сумма КАК Сумма,
	|	ПеремещениеТМЦСписокТМЦ.Склад КАК Склад,
	|	ПеремещениеТМЦСписокТМЦ.ИнвентарныйНомер КАК ИнвентарныйНомер,
	|	ПеремещениеТМЦСписокТМЦ.СерийныйНомер КАК СерийныйНомер,
	|	ПеремещениеТМЦСписокТМЦ.Ссылка.Ссылка КАК Ссылка,
	|	ПеремещениеТМЦСписокТМЦ.Ссылка.Ответственный КАК Ответственный,
	|	ПеремещениеТМЦСписокТМЦ.Ссылка.Номер КАК Номер,
	|	ПеремещениеТМЦСписокТМЦ.Ссылка.Дата КАК Дата,
	|	ПеремещениеТМЦСписокТМЦ.Ссылка.Комментарий КАК Комментарий,
	|	ПеремещениеТМЦСписокТМЦ.ТМЦ.Код КАК ТМЦКод
	|ИЗ
	|	Документ.ПеремещениеТМЦ.СписокТМЦ КАК ПеремещениеТМЦСписокТМЦ
	|ГДЕ
	|	ПеремещениеТМЦСписокТМЦ.Ссылка.Ссылка = &Ссылка";
