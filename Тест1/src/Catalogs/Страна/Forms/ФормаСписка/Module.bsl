...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МожноДобавлятьВСправочник = Справочники.Страна.ЕстьПравоДобавления();
...
Процедура ПриОткрытии(Отказ)
	...
	Если ОткрытьФормуКлассификатора Тогда
		...
		ОткрытьФорму("Справочник.Страна.Форма.Классификатор", ПараметрыОткрытия, ВладелецФормы);
		Отказ = Истина;
	КонецЕсли;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия="Справочник.Страна.Изменение" Тогда
...
Процедура ОткрытьКлассификатор(Команда)
	...
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("ТекущаяСтрока", Элементы.Список.ТекущаяСтрока);
	ОткрытьФорму("Справочник.Страна.Форма.Классификатор", ПараметрыОткрытия, Элементы.Список);
КонецПроцедуры
...
Процедура ВыбратьИзКлассификатора(Команда)
	...
	ПараметрыОткрытия.Вставить("РежимОткрытияОкна", РежимОткрытияОкна);
	ПараметрыОткрытия.Вставить("ТекущаяСтрока", Элементы.Список.ТекущаяСтрока);
	ОткрытьФорму("Справочник.Страна.Форма.Классификатор", ПараметрыОткрытия, Элементы.Список,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура УстановитьОтборПересеченияСКлассификатором()
	...
	Запрос = Новый Запрос("
		...
		|");
	Запрос.УстановитьПараметр("Классификатор", Справочники.Страна.ТаблицаКлассификатора());
