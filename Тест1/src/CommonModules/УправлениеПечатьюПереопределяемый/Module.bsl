...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Справочники.Организация);	
	
	СписокОбъектов.Добавить(Документы.ПредварительныйСчет);	
	СписокОбъектов.Добавить(Документы.ПродажаЗапчастей);	
	...
	СписокОбъектов.Добавить(Документы.ПоступлениеЗапчастей);	
	СписокОбъектов.Добавить(Справочники.Пользователи);	
	СписокОбъектов.Добавить(Документы.Задача);	
	СписокОбъектов.Добавить(Документы.Приказ);	
	СписокОбъектов.Добавить(Документы.ЗаявкаНаСборку);	
	СписокОбъектов.Добавить(Справочники.Сотрудники);	
	СписокОбъектов.Добавить(Документы.Доверенность);	
	СписокОбъектов.Добавить(Документы.СписаниеЗапчастей);	
	
	СписокОбъектов.Добавить(Документы.КадровыйПриказ);
	СписокОбъектов.Добавить(Документы.НачислениеЗарплаты);
	СписокОбъектов.Добавить(Документы.ТабельОтработанногоВремени);
	СписокОбъектов.Добавить(Документы.УвольненияСотрудников);
	
	
	СписокОбъектов.Добавить(Документы.УстановкаМестХранения);	
	СписокОбъектов.Добавить(Документы.ЗаявкаНаОбслуживание);	
	СписокОбъектов.Добавить(Документы.ПеремещениеТоплива);	
	СписокОбъектов.Добавить(Документы.УстановкаЦенНоменклатуры);	
	СписокОбъектов.Добавить(Документы.ЗаказКлиента);	
	СписокОбъектов.Добавить(Документы.ЗаявкаНаРасход);	
