...
Функция ПолучитьТоварGetProduct(Запрос)
	...
	Для каждого стр из ТЗ Цикл
		...
		СтруктураРекомендованноеМесто.Вставить("sklad",    Строка(стр.Склад));
		СтруктураРекомендованноеМесто.Вставить("place",    Строка(стр.Адрес));
		СтруктураРекомендованноеМесто.Вставить("poddon", Строка(стр.Поддон));
		СтруктураРекомендованноеМесто.Вставить("count",    Строка(стр.Количество));
		...
		///+ГомзМА 20.05.2024
		СтруктураТоваров.Вставить("recommended_place", 	 РекомендованноеМестоХранения);
		///-ГомзМА 20.05.2024
