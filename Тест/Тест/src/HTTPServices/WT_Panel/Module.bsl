...
Функция текстДляТиповТоваров2()
	Текст = "ВЫБРАТЬ
			...
			|ГДЕ
			|	РегистрНакопления1Остатки.КолвоОстаток > 0
			|	И ((РегИндНомер.индкод.Владелец.Наименование ПОДОБНО &Наименование СПЕЦСИМВОЛ ""~"" ИЛИ РегИндНомер.индкод.Владелец.Наименование ПОДОБНО Замены.Замена СПЕЦСИМВОЛ ""~"")
