...
Функция ПолучитьПринятыеgetreceived(Запрос)
	...
	ЗапросПерещений.УстановитьПараметр("Группанач",		МассивРегиональныхСтеллажей);
	...
	ЗапросКоличествоПоСотруднику.УстановитьПараметр("Группанач",				МассивРегиональныхСтеллажей);
