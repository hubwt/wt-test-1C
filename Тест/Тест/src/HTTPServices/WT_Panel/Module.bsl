...
Функция ДопИнфаЗвонкиМенеджерыadddatamanagercalls(Запрос)
	...
	Если РезультатЗапроса.Количество() > 0 Тогда
		Пока РезультатЗапроса.Следующий() Цикл
			...
			СтруктураМенеджеров.Вставить("manager", РезультатЗапроса.Менеджер);
			СтруктураМенеджеров.Вставить("count_client", РезультатЗапроса.КоличествоКлиентов);
			СтруктураМенеджеров.Вставить("money", РезультатЗапроса.СуммаПоступлений);
