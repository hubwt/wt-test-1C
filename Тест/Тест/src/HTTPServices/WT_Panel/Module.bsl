...
Функция ПолучитьСтатистикуПродажgetsalesstatistics(Запрос)
	...
	МассивДолжностейМенеджеровПродажи.Добавить("000000114");
	МассивДолжностейМенеджеровПродажи.Добавить("000000093");
	МассивДолжностейМенеджеровПродажи.Добавить("000000003");
	Пока Сотрудники.Следующий() Цикл
		...
		ЗапросМенеджеров.Текст =  "ВЫБРАТЬ ПЕРВЫЕ 1
		                          ...
		                          |	И ДолжностиСотрудниковСрезПоследних.Должность.Наименование В (&МассивДолжностейМенеджеровПродажи)
		                          |
		                          |УПОРЯДОЧИТЬ ПО
