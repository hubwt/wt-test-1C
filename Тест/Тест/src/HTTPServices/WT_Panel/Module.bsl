...
Функция ДашбордРВРgetdashrvr(Запрос)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СУММА(ЗаказНарядРаботы.Сумма) КАК СуммаРабот,
	|	СУММА(ЗаказНарядРаботы.ВремяФакт) КАК ВремяРабот,
	|	СУММА(ЗаказНарядТМЦ.Количество) КАК КоличествоРасходников,
	|	СУММА(ЗаказНарядТМЦ.Сумма) КАК СуммаРасходников,
	|	СУММА(ЗаказНарядТовары.Сумма) КАК СуммаДеталей,
	|	СУММА(ЗаказНарядТовары.Количество) КАК КоличествоДеталей,
	|	ЗаказНаряд.Номер КАК Номер,
	|	ВТ_Приход.СуммаДокумента КАК СуммаДокумента,
	|	ЗаказНаряд.Состояние КАК Состояние,
	|	ЗаказНаряд.ТипНаценки КАК ТипНаценки
	|ИЗ
	|	Документ.ЗаказНаряд КАК ЗаказНаряд
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказНаряд.Товары КАК ЗаказНарядТовары
	|		ПО ЗаказНаряд.Ссылка = ЗаказНарядТовары.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказНаряд.Работы КАК ЗаказНарядРаботы
	|		ПО ЗаказНаряд.Ссылка = ЗаказНарядРаботы.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказНаряд.ТМЦ КАК ЗаказНарядТМЦ
	|		ПО ЗаказНаряд.Ссылка = ЗаказНарядТМЦ.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_Приход КАК ВТ_Приход
	|		ПО ЗаказНаряд.Ссылка = ВТ_Приход.Сделка
	|СГРУППИРОВАТЬ ПО
	|	ЗаказНаряд.Ссылка,
	|	ВТ_Приход.СуммаДокумента,
