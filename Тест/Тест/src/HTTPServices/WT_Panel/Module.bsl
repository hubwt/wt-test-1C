...
//			|
	Текст = "ВЫБРАТЬ
			...
			|ГДЕ
			|	РегистрНакопления1Остатки.КолвоОстаток > 0
			|	И ((РегИндНомер.индкод.Владелец.Наименование ПОДОБНО &Наименование СПЕЦСИМВОЛ ""~"" ИЛИ РегИндНомер.индкод.Владелец.НомераЗамен.НомерЗамены ПОДОБНО Замены.Замена СПЕЦСИМВОЛ ""~"")
