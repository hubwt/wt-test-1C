...
Функция СменаСтатусаЗаявкиChangeStateApp(Запрос)
	...
	Если Статус = 2 Тогда 
		...
		ИЛИ Заявка.Номер = "54195"
		ИЛИ Заявка.Номер = "54321"
		ИЛИ Заявка.Номер = "54334"
		ИЛИ Заявка.Номер = "54332"
		ИЛИ Заявка.Номер = "54331"
		ИЛИ Заявка.Номер = "54333"
		ИЛИ Заявка.Номер = "54354") Тогда
