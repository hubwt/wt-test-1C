...
//	КонецЕсли;
	...
	/// Комлев 22/07/24 +++
	ТекстЗаменыОтборПоСтатусуДействия = " И ЗаказКлиента.СтатусыДействия = &СтатусыДействия";
	ТекстЗаменыОтборПоФинансовомуСтатусу = " И ЗаказКлиента.ФинансовыеСтатусы = &ФинансовыеСтатусы";
