...
Функция СменаСтатусаЗаявкиChangeStateApp(Запрос)
	...
	Если Статус = 2 Тогда 
		...
		Заявка.Номер 	 = "000054204"
		ИЛИ Заявка.Номер = "000054206"
		ИЛИ Заявка.Номер = "000054207"
		ИЛИ Заявка.Номер = "000054208"
		ИЛИ Заявка.Номер = "000054195"
		ИЛИ Заявка.Номер = "000054321"
		ИЛИ Заявка.Номер = "000054334"
		ИЛИ Заявка.Номер = "000054332"
		ИЛИ Заявка.Номер = "000054331"
		ИЛИ Заявка.Номер = "000054333"
		ИЛИ Заявка.Номер = "000054354") Тогда
...
Функция КоличествоЗаявокПоСтатусамgetcountapp(Запрос)
	...
	Пока ВЫборка.Следующий() Цикл
		...
		//СтруктураТоваров.Вставить("sub_states", Выборка.Количество);
		
		Если Выборка.КодСтатуса = "000000015" Тогда
