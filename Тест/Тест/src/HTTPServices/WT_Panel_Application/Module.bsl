...
Функция НаполнитьЗаявкуfillingapplication(Запрос)
	...
	Пока выборка.Следующий() Цикл
		...
		Если НайденныеСтроки.количество() > 0 Тогда 
			...
			ТекстЛога =  " В продаже " + ОбъектЗаявки.номер + " установил партию в товаре " + СтрокаТЧ.Товар + " "+ СтрокаТЧ.Партия; 
		...
		Иначе
			...
			Если НайденныеСтроки.количество() > 0 Тогда 
				...
				ТекстЛога =  " В продаже " + ОбъектЗаявки.номер + " установил выдал партию в товаре " + СтрокаТЧ.Номенклатура + " "+ СтрокаТЧ.Партия; 
				ЛогированиеWT10(Выборка.ссылка,Автор,ТекстЛога);
