...
//	КонецЕсли;
	...
	Для Каждого Результат Из СписокПоиска Цикл
		Попытка
			ФинСтатусСтруктура = Новый Структура;
			СтатусДействияСтруктура = Новый Структура;
			ФинСтатусСтруктура.Вставить("id", Число(Результат.ФинансовыеСтатусы) + 1);
			ФинСтатусСтруктура.Вставить("name", Строка(Результат.ФинансовыеСтатусыИмя));
			СтатусДействияСтруктура.Вставить("id", Число(Результат.СтатусыДействия) + 1);
			СтатусДействияСтруктура.Вставить("name", Строка(Результат.СтатусыДействияИмя));
		Исключение
			ФинСтатусСтруктура = Новый Структура;
			СтатусДействияСтруктура = Новый Структура;
			ФинСтатусСтруктура.Вставить("id", Число(0));
			ФинСтатусСтруктура.Вставить("name", Строка(Результат.ФинансовыеСтатусыИмя));
			СтатусДействияСтруктура.Вставить("id", Число(0));
			СтатусДействияСтруктура.Вставить("name", Строка(Результат.СтатусыДействияИмя));
		КонецПопытки;	
			...
			СтруктураЗаявок.Вставить("action_status", СтатусДействияСтруктура);
			СтруктураЗаявок.Вставить("fin_state", ФинСтатусСтруктура);
