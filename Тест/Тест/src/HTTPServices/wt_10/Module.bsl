...
Функция ПолучитьПоследнийУчтенныйТоварGetLastCountedProducts(Запрос)
	...
	ТабЗнч.Колонки.Добавить("dateTimeLastPhotoAdded");
	...
	Для Каждого Элемент Из Фото Цикл
		...
		КонецЕсли;
		НовСтр.dateTimeLastPhotoAdded = Строка(Элемент.dateTimeLastPhotoAdded);
	...
	Пока Выборка.Следующий() Цикл
		...
		НайденнаяСтрока  = ТабЗнч.Найти(Строка(Выборка.Партия));
		Если НайденнаяСтрока <> Неопределено Тогда
			СтруктураТовара = Новый Структура;
			СтруктураРаботник = Новый Структура;
			СтруктураТовара.Вставить("id", Выборка.Партия);
			СтруктураТовара.Вставить("date", Строка(Выборка.Дата));
			...
			СтруктураТовара.Вставить("worker", СтруктураРаботник);
			СтруктураРаботник.Вставить("photographer", Строка(НайденнаяСтрока.photographer));
