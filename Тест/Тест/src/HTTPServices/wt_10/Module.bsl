...
//++ МазинЕС 24-07-2024
	...
	Запрос.Текст =
		...
		|	И ЗаказКлиентаТовары.Партия.Наименование <> НЕОПРЕДЕЛЕНО";
	...
	Фотки = ПолучениеФото(МассивИндкод); 
...
//++ МазинЕС 24-07-2024	
	...
	Фтоки = ТекстЗапросаПопулярныйТоварИзЗаявок();  
	Структура = Новый Структура(); 
	Структура.Вставить("tovar",Фтоки);
