...
Функция ПолучитьКарточкуТовараgetcardproduct(Запрос)
	...
	Пока выборка.Следующий() Цикл
		...
		СтруктураИнфо.Вставить("price", Строка(Выборка.РекомендованаяЦена));
		Код = выборка.Код;
...
Функция ПолучитьБонусыПоПродажеgetbonusbysale(Запрос)
	...
	ЗапросБонусыПоПродажам.УстановитьПараметр("Сотрудник", 		Выборка.Сотрудник);
	...
	Пока РезультатЗапроса.Следующий() Цикл
		...
		СтруктураБонусовПоПродажам.Вставить("money_sale", 	Строка(РезультатЗапроса.Сумма));
		СтруктураБонусовПоПродажам.Вставить("bonus", 		Строка(РезультатЗапроса.Бонус));
	...
	КонецЦикла;
		СтруктураОтвета.Вставить("bonus_by_sale", МассивБонусовПоПродажам);
