...
//++ МазинЕС 24-07-2024	
	...
	ЗаписьJSON = Новый ЗаписьJSON;
	ЗаписьJSON.УстановитьСтроку();
	СтруктураОтвет = ТекстЗапросаПопулярныйТоварИзЗаявок(Количество, Страница, Город, ФильтрПоКоличеству);
...
//	///-ГомзМА 25.07.2024
//КонецФункции
Функция ТекстЗапросаПопулярныйТоварИзЗаявок(Количество, Страница, Город, ФильтрПоКоличеству)
//++ МазинЕС 24-07-2024/
