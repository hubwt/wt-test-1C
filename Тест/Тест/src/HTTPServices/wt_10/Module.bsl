...
//			Флаг = ложь; 
//			Для каждого элементМассива Из СтрокаОтвет Цикл 
//				Если элементМассива.urls <> 0 тогда 
//					Флаг = Истина; 
//				КонецЕсли; 
//			КонецЦикла; 
//			Массив.Добавить(СтрокаОтвет); 
//		КонецЦикла; 
		 // --
		Возврат Ответ; 
	Исключение
...
//++ МазинЕС 24-07-2024	
	...
	Для Каждого Строка Из Фотки Цикл 
			...
			Если Строка.urls.Количество() <> 0 Тогда
				...
				КоличествоФоток = КоличествоФоток + Строка.urls.Количество(); 
			КонецЕсли; 
	КонецЦикла; 
...
Функция ПулучитьДанныеКлиентаПолучитьДанныеКлиента(Запрос)
