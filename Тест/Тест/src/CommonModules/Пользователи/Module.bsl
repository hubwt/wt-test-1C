...
Функция РолиДоступны(ИменаРолей,
                     ...
                     УчитыватьПривилегированныйРежим = Истина, УчитыватьПолныеПрава = Истина) Экспорт
	...
	Если РольАдминистраторСистемы И РольПолныеПрава
		И УчитыватьПолныеПрава Тогда
		Возврат Истина;
	КонецЕсли;
	...
	Если УчитыватьПолныеПрава Тогда
