...
Функция СоздатьXMLФайл(Каталог, СсылкаНаДокумент, Менеджер) Экспорт
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Иначе 
			...
			ЗаписьXML.ЗаписатьАтрибут("НаимЭконСубСост", "Индивидуальный предприниматель");
			ЗаписьXML.ЗаписатьАтрибут("ИННФЛ", ДанныеПечати.Грузоотправитель.ИНН);
			ЗаписьXML.ЗаписатьНачалоЭлемента("ФИО");
			ЗаписьXML.ЗаписатьАтрибут("Фамилия", "Индивидуальный предприниматель " + СтрРазделить(ДанныеПечати.Грузоотправитель.ПолноеНаименование, " ")[2]);
			ЗаписьXML.ЗаписатьАтрибут("Имя", СтрРазделить(ДанныеПечати.Грузоотправитель.ПолноеНаименование, " ")[3]);
			ЗаписьXML.ЗаписатьАтрибут("Отчество", СтрРазделить(ДанныеПечати.Грузоотправитель.ПолноеНаименование, " ")[4]);
		...
		Иначе
			...
			ЗаписьXML.ЗаписатьНачалоЭлемента("ФИО");
			ЗаписьXML.ЗаписатьАтрибут("Фамилия", "Индивидуальный предприниматель " + СтрРазделить(ДанныеПечати.Грузополучатель.ПолноеНаименование, " ")[2]);
			ЗаписьXML.ЗаписатьАтрибут("Имя", СтрРазделить(ДанныеПечати.Грузополучатель.ПолноеНаименование, " ")[3]);
			ЗаписьXML.ЗаписатьАтрибут("Отчество", СтрРазделить(ДанныеПечати.Грузополучатель.ПолноеНаименование, " ")[4]); 
			ЗаписьXML.ЗаписатьКонецЭлемента(); // Закрываем ФИО
		КонецЕсли;
