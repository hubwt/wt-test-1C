...
Функция СоздатьXMLФайл(Каталог, СсылкаНаДокумент, Менеджер) Экспорт
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Иначе 
			...
			ЗаписьXML.ЗаписатьАтрибут("Фамилия", СтрРазделить(ДанныеПечати.Грузоотправитель.ПолноеНаименование, " ")[2]);
		...
		Иначе
			...
			ЗаписьXML.ЗаписатьНачалоЭлемента("ФИО");
			ЗаписьXML.ЗаписатьАтрибут("Фамилия", СтрРазделить(ДанныеПечати.Грузополучатель.ПолноеНаименование, " ")[2]);
