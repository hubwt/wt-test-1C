...
//	ЕстьРеквизитСчетОрганизации      = ОбщегоНазначения.ЕстьРеквизитОбъекта("СчетОрганизации",      МетаданныеДокумента);
	...
	//И Не ЗначениеЗаполнено(ДокументОбъект.СуммаДокументаНДС) И ДанныеЗаполнения <> Неопределено   Тогда
	//	
	//	Если ДанныеЗаполнения.Основание <> Тип("ДокументСсылка.ЗаказКлиента") Тогда 
