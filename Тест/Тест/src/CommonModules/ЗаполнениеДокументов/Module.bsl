...
//	ЕстьРеквизитСчетОрганизации      = ОбщегоНазначения.ЕстьРеквизитОбъекта("СчетОрганизации",      МетаданныеДокумента);
	...
	Если ДанныеЗаполнения <> Неопределено Тогда 
		ЕСли НЕ (ТипЗнч(ДанныеЗаполнения.Основание.Ссылка) = ТИп("ДокументСсылка.ЗаказКлиента") ИЛИ ТипЗнч(ДанныеЗаполнения.Основание.Ссылка) = ТИп("ДокументСсылка.ЗаказНаряд"))   Тогда 
