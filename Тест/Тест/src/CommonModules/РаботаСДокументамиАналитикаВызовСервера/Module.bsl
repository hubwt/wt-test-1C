...
Функция ПолучитьРазницуДат(ДатаНачало, ДатаКонец) Экспорт
	...
	// Если разница лет и месяцев равна 0, но дни положительные
	// например, в случае с датами 15.08.2024 и 30.08.2024
	Если РазницаЛет = 0 И РазницаМесяцев = 0 Тогда
		РазницаМесяцев = 0; // для ясности оставим месяцы равными 0
		РазницаДней = День(ДатаКонец) - День(ДатаНачало);
	КонецЕсли;
