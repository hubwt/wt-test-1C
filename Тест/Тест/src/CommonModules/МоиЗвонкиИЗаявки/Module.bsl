...
Процедура СоздатьЗаявкиПоЗвонкамНаСервере() Экспорт 
	...
	Пока РезультатЗапросаТелефонов.Следующий() Цикл 
		...
		Если   ОткрытаяЗаявкаПоЗвонку = Неопределено Тогда
			// ++ У Муравьева пишем звонки но не создаем заявки
			Если НЕ РезультатЗапросаЗаявок.Менеджер = Справочники.Пользователи.НайтиПоНаименованию("Муравьев Андрей Александрович") ТОгда 
