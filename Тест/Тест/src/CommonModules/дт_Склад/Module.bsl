...
Функция ТекстЗапросаПоискНоменклатурыПоНомеруПроизводителяИлиНомеруЗамены() Экспорт
	Текст = "ВЫБРАТЬ
	        ...
	        |ГДЕ
	        |	Номенклатура.НомерПроизводителя = &НомерПроизводителя
	        |
	        |ОБЪЕДИНИТЬ
	        |
	        |ВЫБРАТЬ
	        ...
	        |ГДЕ
	        |	НоменклатураНомераЗамен.НомерЗамены = &НомерПроизводителя
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |			(ВЫБРАТЬ
	        |				Вт_НайденнаяНоменклатура.Ссылка
	        |			ИЗ
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ ПЕРВЫЕ 1
	        |	Вт_НайденнаяНоменклатура.Ссылка КАК Деталь,
	        |	Вт_НайденнаяНоменклатура.Ссылка.ДатаСоздания КАК ДатаСоздания,
	        ...
	        |	Вт_НайденнаяНоменклатура.Ссылка.Код КАК Код
	        |ИЗ
	        |	Вт_НайденнаяНоменклатура КАК Вт_НайденнаяНоменклатура
	        |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.РегистрНакопления1.Остатки КАК РегистрНакопления1Остатки
	        |		ПО (РегистрНакопления1Остатки.Товар = Вт_НайденнаяНоменклатура.Ссылка)
	        |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.Продажи КАК Продажи
	        |		ПО (Продажи.Номенклатура = Вт_НайденнаяНоменклатура.Ссылка)
	        ...
	        |		ПО (ВТ_Спрос.Номенклатура = Вт_НайденнаяНоменклатура.Ссылка)
	        |
	        |УПОРЯДОЧИТЬ ПО
	        |	ДатаСоздания,
