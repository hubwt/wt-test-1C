...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.Отчеты, НСтр("ru = 'Отчеты'"));
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.ЗакупкаТовара);
КонецПроцедуры
...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	//ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.ПриходДенегНаСчет);
	//ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.НачислениеЗарплаты);
	//   Отчеты.ОтчетОДвиженияхДокумента.ДобавитьКомандуОтчетОДвиженияхДокумента(КомандыОтчетов, Параметры,     ДокументыСОтчетомОДвижениях);
