...
//		КонецПопытки;
		...
		// =============================================================================================================
		СтароеМестоХранения = Выборка.Стеллаж;
		НовоеМестоХранения 	= Место;
		Партия				= Индкод; 
		СместаМестаХраненияиндНомера.ПеремещениеДеталейРВР(СтароеМестоХранения,НовоеМестоХранения,Партия);
		// =============================================================================================================
