...
Процедура ОбновитьСписок()
	Текст = "ВЫБРАТЬ
	        ...
	        |		ПО (ПриоритетыЗадач.Задача = ДокументЗадача.Ссылка)";
	...
	//	СписокВыполненых.Параметры.УстановитьЗначениеПараметра("Статус",ОтборСтатус);
	//Иначе
	//	
	//КонецЕсли;
	
	
	//Волков ИО 14.12.23 -- ОтборСтатус
...
Процедура ЗаполнитьСписки()
	...
	Элементы.Проект.СписокВыбора.Добавить(Справочники.ПроектыРазвития.ПустаяСсылка(), "ВСЕ");
	...
	//Элементы.ОтборСтатус.СписокВыбора.Добавить(Перечисления.СтатусыЗадач.ВРаботе);
	//
	//Элементы.ОтборПроект.СписокВыбора.Очистить();
	//Элементы.ОтборПроект.СписокВыбора.Добавить(Справочники.ПроектыРазвития.ПустаяСсылка(), "ВСЕ");
	//Волков ИО 14.12.23 --
