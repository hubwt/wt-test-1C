...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	//ТекущиеДанные.Партия = ПолучитьРандомнуюПартию(ТекущиеДанные.Номенклатура);
	///-ГомзМА 12.12.2023
...
Процедура ОткрытьНаСайте(Команда)
	...
	Артикул = ПолучитьАртикулНоменклатуры(Элементы.Товары.ТекущиеДанные.Номенклатура); 
	
	ОбщДействия.ПоискКодаНаСайте(Артикул);
...
Функция ПолучитьАртикулНоменклатуры(Номенклатура)
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Номенклатура, "Артикул");
КонецФункции
