...
Процедура ЗакупленныйТоварКоличествоПриИзменении(Элемент)
	...
	КонецЕсли;
	ТекДанные.ЦинаВЗаказНаряде = (ТекДанные.СуммаЗакупки - ТекДанные.СуммаНДС) / ТекДанные.Количество;
...
Процедура ОрганизацияПриИзменении(Элемент)
	Для Каждого СтрокаТЧ Из Объект.ЗакупленныйТовар Цикл
		...
		СтрокаТЧ.ЦинаВЗаказНаряде = (СтрокаТЧ.СуммаЗакупки - СтрокаТЧ.СуммаНДС) / СтрокаТЧ.Количество;
	КонецЦикла;
КонецПроцедуры
