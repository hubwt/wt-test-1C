...
Функция ПечатьПриказ(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		ДопПараметры.Вставить("НомерИсходящий", дт_ПрефиксацияКлиентСервер.НомерНаПечать(ДанныеПечати.Номер));
...
//		ДопПараметры.Вставить("Описание", ДанныеПечати.Описание);
	...
	Штрихкод.ЗначениеКода = "{ ""id_doc"":"+ """" + ДанныеПечати.Номер + """" + ",""type"":" +" ""Приказ""}";
