...
//					 
//					МенеджерЗаписи.Период					= ТекущаяДата()+ Сек; 
...
//					МенеджерЗаписи.Сумма					= ТекСтрокаСписокТМЦ.Цена; 
...
//					МенеджерЗаписи.Цена						= ТекСтрокаСписокТМЦ.Цена;
//					МенеджерЗаписи.Сумма					= ТекСтрокаСписокТМЦ.Цена * ТекСтрокаСписокТМЦ.Количество;
//					МенеджерЗаписи.Коментарий				= Расход.Комментарий; 
//					
//					МенеджерЗаписи.Филиал 					= Филиал;
//					МенеджерЗаписи.Отдел 					= Отдел;
