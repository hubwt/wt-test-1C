 ...
 Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
 	...
 	Для Каждого СтрокаТЧ Из Объект.Сотрудники Цикл
		...
		Если ЗаписьВРегистреСведений.Выбран() И ЗаписьВРегистреСведений.Увольнение = Документы.УвольненияСотрудников.ПустаяСсылка() Тогда
			...
			ЗаписьВРегистреСведений.ПериодРаботы 		= РаботаСДокументамиАналитикаВызовСервера.ПолучитьРазницуДат(ЗаписьВРегистреСведений.ДатаЗакрытия, ЗаписьВРегистреСведений.ДатаУвольнения);
			ЗаписьВРегистреСведений.ПричинаУвольнения 	= Объект.ПричинаУвольнения;
