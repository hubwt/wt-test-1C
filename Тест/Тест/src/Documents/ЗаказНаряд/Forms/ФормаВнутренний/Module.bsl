...
Процедура УстановитьСписокВыбора()
	...
	//	Элементы.Состояние.СписокВыбора.Добавить(Перечисления.СостоянияЗаказНаряда.ВРаботе);
	//	Элементы.Состояние.СписокВыбора.Добавить(Перечисления.СостоянияЗаказНаряда.Выполнен);
	//КонецЕсли;
	///-ГомзМА 03.10.2023
