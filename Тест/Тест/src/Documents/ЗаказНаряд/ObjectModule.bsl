...
Если  Дата(2025,03,15)  < Дата тогда 
		...
		Запрос.Текст =
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	ВТ_ТЧЗаказНаряд.Товар КАК Товар,
			|	ВТ_ТЧЗаказНаряд.индкод КАК индкод,
			|	ПРЕДСТАВЛЕНИЕССЫЛКИ(ВТ_ТЧЗаказНаряд.Товар) КАК ПредставлениеТовар,
			|	ПРЕДСТАВЛЕНИЕССЫЛКИ(ВТ_ТЧЗаказНаряд.индкод) КАК ПредставлениеИндкод,
			...
			|		ПО ВТ_ТЧЗаказНаряд.индкод = РегистрНакопления1Остатки.индкод";
...
Иначе 
	...
	Сообщение = Новый СообщениеПользователю();
	Сообщение.Текст = "Провел документ БЕЗ контролем остатков "; 
	Сообщение.Сообщить();
