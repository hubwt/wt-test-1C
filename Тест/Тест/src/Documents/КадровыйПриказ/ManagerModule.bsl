...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.Текст =
		ТекстЗапросаДолжностиСотрудников(НомераТаблиц)
		+ ТекстЗапросаНадбавки(НомераТаблиц);
...
Функция ТекстЗапросаРеквизитыДокумента(НомераТаблиц)
	...
	|ПОМЕСТИТЬ Реквизиты
	|ИЗ
	|	Документ.КадровыйПриказ КАК Реквизиты
	|ГДЕ
...
Функция ТекстЗапросаДолжностиСотрудников(НомераТаблиц)

	НомераТаблиц.Вставить("ТаблицаДолжностиСотрудников", НомераТаблиц.Количество());
	
	ТекстЗапроса =
	"ВЫБРАТЬ
	|	ВЫБОР
	|		КОГДА Таблица.Дата = ДАТАВРЕМЯ(1, 1, 1)
	|			ТОГДА Реквизиты.Дата
	|		ИНАЧЕ Таблица.Дата
	|	КОНЕЦ КАК Период,
	|	Таблица.ДатаОформления КАК ДатаОформления,
	...
	|	Таблица.ТипДоговора,
	|	Таблица.ОкладБУ КАК ОкладБУ,
	|	Таблица.Оклад КАК Оклад
	|ИЗ
	|	Документ.КадровыйПриказ.Сотрудники КАК Таблица
...
Функция ТекстЗапросаНадбавки(НомераТаблиц)

	НомераТаблиц.Вставить("ТаблицаНадбавки", НомераТаблиц.Количество());
	...
	|ИЗ
	|	Документ.КадровыйПриказ.Надбавки КАК Таблица
	|		ЛЕВОЕ СОЕДИНЕНИЕ Реквизиты КАК Реквизиты
	|		ПО (ИСТИНА)
	|ГДЕ
	|	Таблица.Ссылка = &Ссылка";
