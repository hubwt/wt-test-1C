...
//
			Если НаборЗаписей.Количество() = 0 Тогда
				...
				Сумма = РаботаСДокументамиВызовСервера.ПолучитьСуммуПродажи(Сделка);
				...
				СписокУчастниковРаботы = РаботаСДокументамиВызовСервера.ПолучитьСписокУчастниковРаботы(Сделка.ЗаказКлиента);
				Итер = 1;
