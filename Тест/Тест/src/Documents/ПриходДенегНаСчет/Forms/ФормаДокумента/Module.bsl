...
Функция ПолучитьРодителяВидыРасходов_3()
	...
	Родитель = Справочники.ВидыРасходов_3.НайтиПоКоду("000000218");
	Возврат Родитель ;
...
//	Объект.Влияние		= Неопределено;
	...
	Форм.Заголовок = "Категории доходов";
КонецПроцедуры
...
Процедура ПриОткрытии(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(Объект.ДатаПрихода) Тогда 
			Объект.ДатаПрихода = объект.Дата; 
	КонецЕсли; 
