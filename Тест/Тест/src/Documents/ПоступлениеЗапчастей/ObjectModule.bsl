	...
	Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
		...
		ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ЗакупкаТовара") Тогда
			...
			Пока Выборка.Следующий() Цикл
				...
				СтрокаТаблицы.ЦенаПоступления = Выборка.ЦенаЗакупки;
				СтрокаТаблицы.СуммаПоступления = Выборка.СуммаЗакупки;
				СтрокаТаблицы.Цена = Выборка.ЦенаПродажи;
				...
				СтрокаТаблицы.ДокументЗакупкаТовара = Выборка.Ссылка;
			КонецЦикла;
			// Комлев АА 16/01/25 +++
		КонецЕсли;  
