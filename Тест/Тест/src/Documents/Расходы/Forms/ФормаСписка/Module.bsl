...
Функция РасчетРасходовПоМесяцам(ДатаНачала, ДатаОкончания)
	...
	|ПОМЕСТИТЬ ВТ_РасходыЛичныйВывод1
	|ИЗ
	...
	|
	|ВЫБРАТЬ
	|	ВТ_РасходыЛичныйВывод1.ВидРасходаНаименование,
	|	"""",
	|	ВТ_РасходыЛичныйВывод1.Сумма
	|ИЗ
	|	ВТ_РасходыЛичныйВывод1 КАК ВТ_РасходыЛичныйВывод1
	|
	|УПОРЯДОЧИТЬ ПО
	|	Сумма УБЫВ";
