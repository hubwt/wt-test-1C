...
//				
//				НоваяЗапись = РегистрыСведений.БюджетТМЦ.СоздатьМенеджерЗаписи(); 
//				
//				НоваяЗапись.ТМЦ						= ТекСтрокаСписокТМЦ.ТМЦ;
//				НоваяЗапись.Расход 					= Структура.Расход;
//				НоваяЗапись.ДокРег					= Ссылка;	
//				НоваяЗапись.ДатаРасхода			= Структура.ДатаРасхода;
//				НоваяЗапись.Период					= Дата;
//				НоваяЗапись.ИнвентарныйНомер 	= ТекСтрокаСписокТМЦ.ИнвентарныйНомер;
//				НоваяЗапись.Количество				= ТекСтрокаСписокТМЦ.Количество;
//				НоваяЗапись.Цена						= ТекСтрокаСписокТМЦ.Цена;
//				НоваяЗапись.Сумма					= ТекСтрокаСписокТМЦ.Количество * ТекСтрокаСписокТМЦ.Цена; 
//				НоваяЗапись.Коментарий				= Структура.Коментарий; 
//				
//				НоваяЗапись.Филиал 					= Филиал;
//				НоваяЗапись.Отдел 					= Отдел;
//				НоваяЗапись.ВидыРасхода_3 		= ВидыРасхода_3;
//				НоваяЗапись.Категрия 				= Категория;
