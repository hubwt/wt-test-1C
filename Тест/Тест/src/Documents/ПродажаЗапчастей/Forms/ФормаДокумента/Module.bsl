...
Процедура СписатьБонусыНаСервере()
	...
	Если Объект.СколькоСписать <> 0  И Объект.БылоСписаниеБонусов = Ложь  И Объект.СколькоСписать <= Объект.СуммаБонусов Тогда
		Объект.БылоСписаниеБонусов = Истина;
		
		Объект.СуммаБонусовДоСписания = Объект.СуммаБонусов;
