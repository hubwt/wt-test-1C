...
Процедура ЗакупленныйТоварКоличествоПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.Организация) Тогда
		ТекДанные.СуммаНДС = (ТекДанные.ЦенаЗакупки * ТекДанные.Количество) * ПолучитьНалогОрганизации(Объект.Организация) / 120;
	Иначе
		ТекДанные.СуммаНДС = 0;
	КонецЕсли;
	ТекДанные.СуммаЗакупки = ТекДанные.ЦенаЗакупки * ТекДанные.Количество + ТекДанные.СуммаНДС;
...
Процедура ОрганизацияПриИзменении(Элемент)
	Для Каждого СтрокаТЧ Из Объект.ЗакупленныйТовар Цикл
		СтрокаТЧ.СуммаНДС = (СтрокаТЧ.ЦенаЗакупки * СтрокаТЧ.Количество) * ПолучитьНалогОрганизации(Объект.Организация) / 120;
		СтрокаТЧ.СуммаЗакупки = СтрокаТЧ.ЦенаЗакупки * СтрокаТЧ.Количество + СтрокаТЧ.СуммаНДС;
	КонецЦикла;
КонецПроцедуры
