...
Процедура АвтозагрузкаАвитоХодовые(МенеджерНаименование) 
	...
	СсылкаНаФайлАвтовыгрузки = "\\192.168.0.245\shared_folder\Autoloads_MarketPlace\Autoload_avito_marketable_manager\avito_marketable" +МенеджерНаименование+ ".xml";
	///-ТатарМА 09.12.2024
