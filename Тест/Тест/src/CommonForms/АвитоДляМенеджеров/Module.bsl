...
//		
//		ОткрытьФорму("РегистрСведений.ИндНомер.Форма.ФормаЗаписи1", Параметрыформы);
		
		
		
		СтандартнаяОбработка = Ложь; 
		СтруктураЗаписи = Новый Структура("индкод",  ПолучитьиндКод(Элементы.СписокТоваровАвитоМенеджер.ТекущиеДанные.индкод));
		...
		ОткрытьФорму("РегистрСведений.ИндНомер.Форма.ФормаЗаписи", Параметрыформы);
КонецПроцедуры
