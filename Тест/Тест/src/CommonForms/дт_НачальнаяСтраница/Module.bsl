...
Процедура ГруппыКлиентовПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	ИначеЕсли ТекущаяСтраница = Элементы.Должники Тогда
		...
		КоличествоДолжников = КоличествоСтрокВСписке("СписокДолжники");
	...
	ИначеЕсли ТекущаяСтраница = Элементы.НеЦелевые Тогда
		...
		КоличествоНеЦелевых = КоличествоСтрокВСписке("СписокНеЦелевые");
...
Процедура СписокГорячиеВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	/// Комлев АА 30/10/24 ++++
//	Если Поле = Элементы.СписокГорячиеПерезвонилиПослеДоставки Тогда
//		СтандартнаяОбработка = Ложь;
//
//		ТекущиеДанные = Элемент.ТекущиеДанные;
//		Если ТекущиеДанные <> Неопределено Тогда
//			Если ТекущиеДанные.ПерезвонилиПослеДоставки = Истина Тогда
//				СнятьЗвонок(ТекущиеДанные.Клиент);
//			Иначе
//				ПоставитьЗвонок(ТекущиеДанные.Клиент);
//			КонецЕсли;
//		КонецЕсли;
...
&НаСервере
Процедура СнятьЗвонок(Клиент)
	Док = Клиент.ПолучитьОбъект();
	Док.ПерезвонилиПослеДоставки = Ложь;
	Док.Записать();
КонецПроцедуры

&НаСервере
Процедура ПоставитьЗвонок(Клиент)
	Док = Клиент.ПолучитьОбъект();
	Док.ПерезвонилиПослеДоставки = Истина;
	Док.Записать();
КонецПроцедуры
