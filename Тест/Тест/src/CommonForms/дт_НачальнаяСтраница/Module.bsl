...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//временно
	Если НЕ ПользователиИнформационнойБазы.ТекущийПользователь().ПолноеИмя = "Татарникова Маргарита Александровна" Тогда
		Элементы.ВыгрузитьВЭксельТелефоныАктивные.Видимость = Ложь;
		Элементы.ВыгрузитьВЭксельТелефоныГорячие.Видимость 	= Ложь;
		Элементы.ВыгрузитьВЭксельТелефоныТеплые.Видимость 	= Ложь;	
	КонецЕсли;
