...
Процедура ОтключитьВыполнениеДинамическихСписков()
	...
	///+ТатарМА 24.10.2024
//	СписокАктивные.ДинамическоеСчитываниеДанных 	= Истина;
//	СписокТеплые.ДинамическоеСчитываниеДанных 		= Истина;
//	СписокПотенциальные.ДинамическоеСчитываниеДанных = Истина;
//	СписокХолодные.ДинамическоеСчитываниеДанных = Истина;
//	Список.ДинамическоеСчитываниеДанных = Истина;
//	СписокОбязанности.ДинамическоеСчитываниеДанных = Истина;
//	СписокПродажи.ДинамическоеСчитываниеДанных = Истина;
//	СписокПродажДляЗП.ДинамическоеСчитываниеДанных = Истина;
//	ПоЧастям.ДинамическоеСчитываниеДанных = Истина;
//	СписокОстатковНаСчёте.ДинамическоеСчитываниеДанных = Истина;
//	Инвентарь.ДинамическоеСчитываниеДанных = Истина;
//	ЖурналПродажи.ДинамическоеСчитываниеДанных = Истина;
//	СписокДенежныеПоказатели.ДинамическоеСчитываниеДанных = Истина;
//	СписокДенежныйПоток.ДинамическоеСчитываниеДанных = Истина;
//	СписокДетализацияРасходов.ДинамическоеСчитываниеДанных = Истина;
//	СписокОжидаемыйПриходДенег.ДинамическоеСчитываниеДанных = Истина;
//	СписокНеоплаченныеЗаявкиНаРасход.ДинамическоеСчитываниеДанных = Истина;
//	СписокПомощьВПродажеМой.ДинамическоеСчитываниеДанных = Истина;
//	СписокКлиенты.ДинамическоеСчитываниеДанных = Истина;
//	СписокПродажиПользователь.ДинамическоеСчитываниеДанных = Истина;
//	СписокДоставки.ДинамическоеСчитываниеДанных = Истина;
//	СписокУчетТоваров.ДинамическоеСчитываниеДанных = Истина;
//	СписокПеремещениеТовара.ДинамическоеСчитываниеДанных = Истина;
//	СписокПриёмкаТовара.ДинамическоеСчитываниеДанных = Истина;
//	СписокУстановкаМестаХранения.ДинамическоеСчитываниеДанных = Истина;
//	СписокВыполненныеРаботы.ДинамическоеСчитываниеДанных = Истина;
//	СписокСозданныеЗакзНаряды.ДинамическоеСчитываниеДанных = Истина;
//	СписокУщербы.ДинамическоеСчитываниеДанных = Истина;
//	СписокТабель.ДинамическоеСчитываниеДанных = Истина;
//	СписокВыплаты.ДинамическоеСчитываниеДанных = Истина;
//	СприсокПоказателиНастройка.ДинамическоеСчитываниеДанных = Истина;
//	СписокПоказатели.ДинамическоеСчитываниеДанных = Истина;
//	БанковскиеСчетаСотрудников.ДинамическоеСчитываниеДанных = Истина;
//	СписокДети.ДинамическоеСчитываниеДанных = Истина;
//	СписокПоказателиЗП.ДинамическоеСчитываниеДанных = Истина;
//	СписокМоиЗадачи.ДинамическоеСчитываниеДанных = Истина;
//	СписокАдминистративных.ДинамическоеСчитываниеДанных = Истина;
//	СписокОтпусков.ДинамическоеСчитываниеДанных = Истина;
//	СписокОбязанностей.ДинамическоеСчитываниеДанных = Истина;
//	ДолженЗнать.ДинамическоеСчитываниеДанных = Истина;
//	СписокКвалификаций.ДинамическоеСчитываниеДанных = Истина;
//	СписокКадровыхДвижений.ДинамическоеСчитываниеДанных = Истина;
//	РолиWT10.ДинамическоеСчитываниеДанных = Истина;
	
//		Элементы.СписокАктивные.АвтоЗагрузка = Ложь;
//	Элементы.СписокТеплые.АвтоЗагрузка = Ложь;
//	Элементы.СписокПотенциальные.АвтоЗагрузка = Ложь;
//	Элементы.СписокХолодные.АвтоЗагрузка = Ложь;
//	Элементы.Список.АвтоЗагрузка = Ложь;
//	Элементы.СписокОбязанности.АвтоЗагрузка = Ложь;
//	Элементы.СписокПродажи.АвтоЗагрузка = Ложь;
//	Элементы.СписокПродажДляЗП.АвтоЗагрузка = Ложь;
//	Элементы.ПоЧастям.АвтоЗагрузка = Ложь;
//	Элементы.СписокОстатковНаСчёте.АвтоЗагрузка = Ложь;
//	Элементы.Инвентарь.АвтоЗагрузка = Ложь;
//	Элементы.ЖурналПродажи.АвтоЗагрузка = Ложь;
//	Элементы.СписокДенежныеПоказатели.АвтоЗагрузка = Ложь;
//	Элементы.СписокДенежныйПоток.АвтоЗагрузка = Ложь;
//	Элементы.СписокДетализацияРасходов.АвтоЗагрузка = Ложь;
//	Элементы.СписокОжидаемыйПриходДенег.АвтоЗагрузка = Ложь;
//	Элементы.СписокНеоплаченныеЗаявкиНаРасход.АвтоЗагрузка = Ложь;
//	Элементы.СписокПомощьВПродажеМой.АвтоЗагрузка = Ложь;
//	Элементы.СписокКлиенты.АвтоЗагрузка = Ложь;
//	Элементы.СписокПродажиПользователь.АвтоЗагрузка = Ложь;
//	Элементы.СписокДоставки.АвтоЗагрузка = Ложь;
//	Элементы.СписокУчетТоваров.АвтоЗагрузка = Ложь;
//	Элементы.СписокПеремещениеТовара.АвтоЗагрузка = Ложь;
//	Элементы.СписокПриёмкаТовара.АвтоЗагрузка = Ложь;
//	Элементы.СписокУстановкаМестаХранения.АвтоЗагрузка = Ложь;
//	Элементы.СписокВыполненныеРаботы.АвтоЗагрузка = Ложь;
//	Элементы.СписокСозданныеЗакзНаряды.АвтоЗагрузка = Ложь;
//	Элементы.СписокУщербы.АвтоЗагрузка = Ложь;
//	Элементы.СписокТабель.АвтоЗагрузка = Ложь;
//	Элементы.СписокВыплаты.АвтоЗагрузка = Ложь;
//	Элементы.СприсокПоказателиНастройка.АвтоЗагрузка = Ложь;
//	Элементы.СписокПоказатели.АвтоЗагрузка = Ложь;
//	Элементы.БанковскиеСчетаСотрудников.АвтоЗагрузка = Ложь;
//	Элементы.СписокДети.АвтоЗагрузка = Ложь;
//	Элементы.СписокПоказателиЗП.АвтоЗагрузка = Ложь;
//	Элементы.СписокМоиЗадачи.АвтоЗагрузка = Ложь;
//	Элементы.СписокАдминистративных.АвтоЗагрузка = Ложь;
//	Элементы.СписокОтпусков.АвтоЗагрузка = Ложь;
//	Элементы.СписокОбязанностей.АвтоЗагрузка = Ложь;
//	Элементы.ДолженЗнать1.АвтоЗагрузка = Ложь;
//	Элементы.СписокКвалификаций.АвтоЗагрузка = Ложь;
//	Элементы.СписокКадровыхДвижений.АвтоЗагрузка = Ложь;
//	Элементы.РолиWT10.АвтоЗагрузка = Ложь;
//	
...
Процедура УсловноеОФормлениеГорячиеКлиенты() Экспорт
	/// Комлев АА 30/10/24 ++++
...
Процедура ПолучитьЗвонкиКлиента(МассивСтрок)
	...
	Для Каждого Строка Из МассивСтрок Цикл
		...
		|ГДЕ
		|	ЗаписиЗвонков.Клиент = &Клиент
		|	И ЗаписиЗвонков.ТипЗвонка
		|	И ЗаписиЗвонков.Дата > &Дата
		|
		|УПОРЯДОЧИТЬ ПО
		|	Дата УБЫВ";

		Запрос.УстановитьПараметр("Клиент", Строка.Клиент);
