...
Процедура РассчитатьИтогиДолжники() 
	...
	Элементы.СписокДолжникиМашины.ТекстПодвала =  "Итого: " + Формат(РезультатКД_ТЗ.Итог(
		"Машины"), "ЧДЦ=2; ЧН=-");
		Элементы.СписокДолжникиКоличествоЗаявок.ТекстПодвала =  "Итого: " + Формат(РезультатКД_ТЗ.Итог(
		"КоличествоЗаявок"), "ЧДЦ=2; ЧН=-");
		Элементы.СписокДолжникиКоличествоПродаж.ТекстПодвала =  "Итого: " + Формат(РезультатКД_ТЗ.Итог(
		"КоличествоПродаж"), "ЧДЦ=2; ЧН=-");
		Элементы.СписокДолжникиСуммаПродаж.ТекстПодвала =  "Итого: " + Формат(РезультатКД_ТЗ.Итог(
		"СуммаПродаж"), "ЧДЦ=2; ЧН=-");		
// Комлев АА 21/10/24 ---
КонецПроцедуры
