...
&НаКлиенте
Процедура ОбновитьОтборПартий1()
	//////
	ТекДанные = Элементы.СписокНомВостДеталей.ТекущаяСтрока;
	СписокПартий1.Параметры.УстановитьЗначениеПараметра("Товар", ТекДанные);
...
&НаКлиенте
Процедура СписокПартий2Выбор1(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
...
&НаКлиенте
Процедура СписокПартий2Выбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
