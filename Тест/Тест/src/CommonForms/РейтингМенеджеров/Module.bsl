...
//	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеров1ДоПлана.ГоризонтальноеПоложениеВПодвале 				= ГоризонтальноеПоложениеЭлемента.Право;
	...
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровБезналБезНДС.ТекстПодвала 		 =  Формат(Результат.Итог("БезналБезНДС"),"ЧДЦ=0; ЧН=-");
...
//	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеров1ДоПлана.ГоризонтальноеПоложениеВПодвале 				= ГоризонтальноеПоложениеЭлемента.Право;
	...
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеров1СуммаПоступлений.ТекстПодвала 	 	=  Формат(Результат.Итог("СуммаПоступлений"),"ЧДЦ=0; ЧН=-");
	//ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеров1ДоПлана.ТекстПодвала 	     		=  Формат(Результат.Итог("ДоПлана"),"ЧДЦ=0; ЧН=-");
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровСуммаЗаявок.ТекстПодвала 				=  Формат(Результат.Итог("СуммаЗаявок"),"ЧДЦ=0; ЧН=-");
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровКолПроиграноСделок.ТекстПодвала 		=  Формат(Результат.Итог("КолПроиграноСделок"),"ЧДЦ=0; ЧН=-");
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровСуммаПроигранноСделок.ТекстПодвала 	=  Формат(Результат.Итог("СуммаПроигранноСделок"),"ЧДЦ=0; ЧН=-");
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровКолВсегоЗаявок.ТекстПодвала 			=  Формат(Результат.Итог("КолВсегоЗаявок"),"ЧДЦ=0; ЧН=-");
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровКолВсегоВыйграноСделок.ТекстПодвала 	=  Формат(Результат.Итог("КолВсегоВыйграноСделок"),"ЧДЦ=0; ЧН=-");
...
Процедура ЗаполнениеПодвала()
	...
	ЭтотОбъект.ЭтаФорма.Элементы.ЗаявкиСуммаНетВНаличии.ТекстПодвала  		= Формат(Результат.Итог("СуммаНетВНаличии"),"ЧДЦ=0; ЧН=-");
