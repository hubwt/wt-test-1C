...
//	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеров1ДоПлана.ГоризонтальноеПоложениеВПодвале 				= ГоризонтальноеПоложениеЭлемента.Право;
	...
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровПроиграноСделок.ГоризонтальноеПоложениеВПодвале 		= ГоризонтальноеПоложениеЭлемента.Право;
	...
	ЭтотОбъект.ЭтаФорма.Элементы.РейтингМенеджеровПроиграноСделок.ТекстПодвала 		=  Формат(Результат.Итог("ПроиграноСделок"),"ЧДЦ=0; ЧН=-");
