...
Процедура ОбновлениеСписков(НачалоНедили)	
	...
	МассивСчетов.Добавить(Справочники.Счета.НайтиПоКоду("000000055"));
	МассивСчетов.Добавить(Справочники.Счета.НайтиПоКоду("000000056"));
...
&НаКлиенте
Процедура ОбновиьКалендарь(Команда)
	НачалоНедили = НачалоНедели(Период); 
	ОбновлениеСписков(НачалоНедили); 
КонецПроцедуры
