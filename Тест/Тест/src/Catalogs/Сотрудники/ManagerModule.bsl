...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Идентификатор = "ПФ_DOC_РаспискаОСогласии";
	КомандаПечати.Представление = НСтр("ru = 'Расписка о согласии (Word)'");
	КомандаПечати.Порядок = 1;
КонецПроцедуры


Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	ПечатнаяФорма = УправлениеПечатью.СведенияОПечатнойФорме(КоллекцияПечатныхФорм, "ПФ_DOC_РаспискаОСогласии");
	Если ПечатнаяФорма <> Неопределено Тогда
		СформироватьРаспискаОСогласииWord(МассивОбъектов);
		
	КонецЕсли;
	
КонецПроцедуры

Функция СформироватьРаспискаОСогласииWord(МассивОбъектов)
	Сообщить(МассивОбъектов[0]);
КонецФункции
