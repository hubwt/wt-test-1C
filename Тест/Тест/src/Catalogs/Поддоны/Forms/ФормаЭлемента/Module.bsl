...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Егунов = Справочники.Пользователи.НайтиПоНаименованию("Егунов Александр Николаевич");
	
	Если ТекущийПользователь.Роли.Содержит(Метаданные.Роли.Найти("Руководитель")) ИЛИ
		 ТекущийПользователь.Роли.Содержит(Метаданные.Роли.Найти("ПолныеПрава")) ИЛИ
		 ...
		 ТекущийПользователь.ПолноеИмя = Кузмичёв.Наименование ИЛИ 
		 ТекущийПользователь.ПолноеИмя = Егунов.Наименование Тогда
...
Процедура РазблокироватьКнопкуПечати(Команда)
	...
	Событие = "Разблокировал кнопку печати " + Объект.Наименование;
	ЗаписьЛога(Событие);
	ЭтаФорма.Записать();
КонецПроцедуры
