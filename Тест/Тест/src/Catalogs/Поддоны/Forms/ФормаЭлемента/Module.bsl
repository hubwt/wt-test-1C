...
Процедура ПечатьЭтикетки(Команда)
	...
	Объект.Счетчик = Объект.Счетчик + 1;
	
	Если Объект.Счетчик >= 1 Тогда 
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТекущийПользователь.Роли.Содержит(Метаданные.Роли.Найти("Руководитель")) Тогда
