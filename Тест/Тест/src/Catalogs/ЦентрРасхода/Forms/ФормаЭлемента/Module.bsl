...
//  СхемаКомпоновкиДанных = Отчеты.ОтчетЦентрРасхода.ПолучитьМакет("ОсновнаяСхемаКомпоновкиДанных");
//  Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
//  //параметры СКД
//  Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Дата1")).Значение = Период.ДатаНачала;
//  Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Дата2")).Значение = Период.ДатаОкончания;
//  Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Категория")).Значение = Объект.Категория1;
//  
//  
//  КомпоновщикМакета = Новый КомпоновщикМакетаКомпоновкиДанных;
...
//  ПроцессорВывода = Новый ПроцессорКомпоновкиДанных();;
////  ТабДок = Новый ТабличныйДокумент;
////  ТабДок = Новый ТаблицаЗначений();
//
//  ПроцессорВывода.УстановитьОбъект(ТабДок);
