...
Процедура ЗаполнитьПодвалДинСписок6()
	...
	ЭтотОбъект.ЭтаФорма.Элементы.ДинСписок6СуммаДокумента.ГоризонтальноеПоложениеВПодвале = ГоризонтальноеПоложениеЭлемента.Право;
	ЭтотОбъект.ЭтаФорма.Элементы.ДинСписок6СуммаДокумента.ТекстПодвала = Формат(Результат.Итог("СуммаДокумента"),"ЧДЦ=0; ЧН=-");
