...
Процедура КомандаДляМоегоПиздатогоПоискаНаСервере()
	ТекстЕбейшегоЗапросаСПоиском = "ВЫБРАТЬ
								   ...
								   |////////////////////////////////////////////////////////////////////////////////
								   |ВЫБРАТЬ
								   |	МАКСИМУМ(дт_ЦеныНоменклатурыСрезПоследних.Период) КАК Период,
								   |	дт_ЦеныНоменклатурыСрезПоследних.Номенклатура КАК Номенклатура
								   |ПОМЕСТИТЬ МаксПериод
								   |ИЗ
								   |	РегистрСведений.дт_ЦеныНоменклатуры.СрезПоследних(&ТекДата,) КАК дт_ЦеныНоменклатурыСрезПоследних
								   |СГРУППИРОВАТЬ ПО
								   ...
								   |ИЗ
								   |	РегистрСведений.дт_ЦеныНоменклатуры.СрезПоследних(&ТекДата,) КАК дт_ЦеныНоменклатуры
								   ...
								   |		ПО МестаХраненияНоменклатуры.Номенклатура = ВТ_Предложения.Ссылка";
