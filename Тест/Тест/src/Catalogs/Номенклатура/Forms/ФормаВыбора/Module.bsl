...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.Свойство("Отбор") И Параметры.Отбор.Свойство("Склад") Тогда

		Склад = Параметры.Отбор.Склад;

	КонецЕсли;
	Если Параметры.Свойство("ФормаОткрытаИзЗаявок") Тогда
		Если Параметры.ФормаОткрытаИзЗаявок = Истина Тогда
			Для Каждого ПодчиненныйЭлемент Из ЭтотОбъект.КоманднаяПанель.ПодчиненныеЭлементы Цикл
...
Процедура УстановитьПараметрыСписка()
	...
	// Комлев АА +++
	Если Параметры.ДатаЗаявки <> Дата(1, 1, 1) Тогда
		ДатаЗаявки = Параметры.ДатаЗаявки;
	Иначе
		ДатаЗаявки = ТекущаяДатаСеанса();
	КонецЕсли;
	Список.Параметры.УстановитьЗначениеПараметра("ДатаЗаявки", ДатаЗаявки);
	// Комлев АА ---
